...
import waxa.boost.juntalimpio.espaciosnaturales.listaalojamientos.ListaAlojamientos;
import waxa.boost.juntalimpio.espaciosnaturales.listapuntosinteres.ListaPuntosInteres;
import waxa.boost.juntalimpio.espaciosnaturales.listasendas.ListaSendas;
...
public class Informacion extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.espacios_info_espacio);
        ...
        ImageButton botonSendas = (ImageButton) findViewById(R.id.pt3sendas);
        ImageButton botonAlojamientos = (ImageButton) findViewById(R.id.pt3alojamientos);
        ImageButton botonPuntosInteres = (ImageButton) findViewById(R.id.pt3interes);
    ...
    private void irSendas(){
        Intent i = new Intent(this, ListaSendas.class);
        //i.putExtra("indice",indice);
        startActivity(i);
    }

    private void irAlojamientos(){
        Intent i = new Intent(this, ListaAlojamientos.class);
        startActivity(i);
    }

    private void irPuntosInteres(){
        Intent i = new Intent(this, ListaPuntosInteres.class);
        startActivity(i);
    }
